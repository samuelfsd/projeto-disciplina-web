...
export const Home = () => {
  ...
  return (
    ...
    <Column width="100%" minHeight="300px" p="20px" bg="rgba(255,255,255,0.2)" borderRadius="4px" alignItems="center">
      ...
      <Text fontFamily="secondary" fontSize='displayLarge' fontWeight='bold' py="30px" >{secondsToTime(seconds)}</Text>

      {handleStageButtons}
    </Column>
      
      
      <Text fontSize='bodyLarge' fontWeight='bold' my='20px' pl='10px'>Tasks...</Text>
      <Row width="100%">
